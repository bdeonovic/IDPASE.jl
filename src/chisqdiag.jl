...
function chisqdiag_sub(c::AbstractChains, frac::Real, method::Symbol, 
                       n_sims::Int, start_iter::Int, step_size::Int)
...
function chisqdiagplot(c::AbstractChains; frac::Real=0.3, 
  ...
  V, vals, plot_vals_stat, plot_vals_pval = 
    chisqdiag_sub(c, frac, method, n_sims, start_iter, step_size)
...
function chisqdiag(c::AbstractChains; frac::Real=0.3, 
                   method::Symbol=:weiss, n_sims::Int=1000,
                   start_iter::Int=100, step_size::Int=10000)
  ...
  V, vals = chisqdiag_sub(c, frac, method, n_sims, size(c.value,1), step_size)[1:2]
